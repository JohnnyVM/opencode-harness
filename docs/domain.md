...
- Read `CONTEXT.md` before exploring when it exists.
- Read relevant decisions in `docs/adr/` before exploring the affected area when they exist.
- Missing `CONTEXT.md` or `docs/adr/` documentation does not block the work.
